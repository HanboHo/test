...
chen-python3 "${OD_DIR}/model_main.py" \
    --logtostderr \
    --pipeline_config_path="${OD_DIR}/_pipeline/docker_dgx2_coco_panoptic_mask_rcnn_fpn_resnet101_v1.config" \
    --model_dir="${BASE_DIR}/docker_panoptic_mask_rcnn_fpn_resnet101_v1/train_dgx2_768_estimator_batch3_gpu4_mixprecision" \
    --dataset_name="coco" \
